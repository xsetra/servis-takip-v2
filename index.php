...
<html>
    <head>
        ...
        <title>Servis Takip Giriş Paneli</title>
    ...
    <body>
        <div class="container" align="center">
			...
			<img src="logo.png" align="center"  style="margin-top:120px;" />
...
if(isset($_POST['submit']))
{
	if(empty($_POST['login']) or empty($_POST['password']))
	{
		...
		$sorgu=mysql_query("SELECT * FROM admin WHERE user_id='$login' and password='$pw'");
